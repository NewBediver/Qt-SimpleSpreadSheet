...
void Spreadsheet::cutEdit()
{
    copyEdit();
    deleteEdit();
}

void Spreadsheet::copyEdit()
{
    QTableWidgetSelectionRange range = selectedRange();
    QString str;
...
void Spreadsheet::selectCurrentRowEdit()
{
    selectRow(currentRow());
}

void Spreadsheet::selectCurrentColumnEdit()
{
